...
def function_two_second_derivative():
    def second_derivative(p):
        aone =  ((2*((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])**2*log((1 - p[0])*p[0]*(1 - p[1])*p[1]))/((1 - p[0])**2*p[0]**2*(1 - p[1])**2*p[1]**2*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)**2) +\
                ((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])/((1 - p[0])*p[0]**2*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) -\
                ((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])/((1 - p[0])**2*p[0]*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) +\
                2/((1 - p[0])*p[0]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)))
                
        atwo =  (2*((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])*((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])*log((1 - p[0])*p[0]*(1 - p[1])*p[1]))/((1 - p[0])**2*p[0]**2*(1 - p[1])**2*p[1]**2*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)**2) +\
                ((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])/((1 - p[0])*p[0]*(1 - p[1])*p[1]**2*(log((1 - p[0])**2*p[0]*(1 - p[1])*p[1]) + 1)) -\
                ((1 - p[0])*(1 - p[1]) - p[0]*(1 - p[1]) - (1 - p[0])* p[1] + p[0]*p[1])/((1 - p[0])*p[0]*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) -\
                ((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])/((1 - p[0])*p[0]*(1 - p[1])**2*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1))
                
        athree= (2*((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])*((1 - p[0])*(1 - p[1])*p[1] - p[0]*(1 - p[1])*p[1])*log((1 - p[0])*p[0]*(1 - p[1])*p[1]))/((1 - p[0])**2*p[0]**2*(1 - p[1])**2*p[1]**2*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)**2) +\
                ((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])/((1 - p[0])*p[0]**2*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) -\
                ((1 - p[0])*(1 - p[1]) - p[0]*(1 - p[1]) - (1 - p[0])*p[1] + p[0]*p[1])/((1 - p[0])*p[0]*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) -\
                ((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])/((1 - p[0])**2*p[0]*(1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) 
                
        afour = (2*((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])**2*log((1 - p[0])*p[0]*(1 - p[1])*p[1]))/((1 - p[0])**2*p[0]**2*(1 - p[1])**2*p[1]**2*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)**2) +\
                ((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])/((1 - p[0])*p[0]*(1 - p[1])*p[1]**2*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) -\
                ((1 - p[0])*p[0]*(1 - p[1]) - (1 - p[0])*p[0]*p[1])/((1 - p[0])*p[0]*(1 - p[1])**2*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1)) +\
                2/((1 - p[1])*p[1]*(log((1 - p[0])*p[0]*(1 - p[1])*p[1])**2 + 1))
